...
up-local-k8s:
	cd ./infra/local/k8s && kubectl apply -f ./setup/ && kubectl apply -f ./security/ && kubectl apply -f ./resource/ && kubectl apply -f ./config/ && kubectl apply -f ./sys/ && kubectl apply -f ./app/

down-local-k8s:
	cd ./infra/local/k8s && kubectl delete -f ./app/ && kubectl delete -f ./sys/ && kubectl delete -f ./config/ && kubectl delete -f ./resource/ && kubectl delete -f ./security/ && kubectl delete -f ./setup/
