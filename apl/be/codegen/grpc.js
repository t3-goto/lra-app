    ...
    grpc.health = (function() {
        ...
        health.v1 = (function() {
            ...
            v1.Health = (function() {
                 ...
                 * @instance
                 * @param {grpc.health.v1.IHealthCheckRequest} request HealthCheckRequest message or plain object
                 * @param {grpc.health.v1.Health.WatchCallback} callback Node-style callback called with the error, if any, and HealthCheckResponse
                 * @returns {undefined}
                 * @variation 1
                 */
                Object.defineProperty(Health.prototype.watch = function watch(request, callback) {
                    return this.rpcCall(watch, $root.grpc.health.v1.HealthCheckRequest, $root.grpc.health.v1.HealthCheckResponse, request, callback);
                }, "name", { value: "Watch" });
